...
<template>
    <main class="game-main">
        <GameSettings v-if="gameStatus === 0" gameName="translateIt" @return-settings="getSettings" />
        <GameElements v-else-if="gameStatus === 1" gameName="translate-it-right" :gameSettings="(gameSettings as Settings)" 
